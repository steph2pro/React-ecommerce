    ...
    return (
        ...
        <form onSubmit={(e) => {
            ...
            <div className="relative">
                ...
                <input type="search" id="default-search" onChange={(e) => setState(e.target.value)} className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:w-[100%]" placeholder={"Recherche transaction"} required={true} />
